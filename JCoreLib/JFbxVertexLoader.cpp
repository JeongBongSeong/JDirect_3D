...
FbxVector4 JFbxImporter::ReadNormal(const FbxMesh* mesh,
...
FbxColor JFbxImporter::ReadColor(const FbxMesh* mesh,
...
std::string JFbxImporter::ParseMaterial(FbxSurfaceMaterial* pMtrl)
{
...
void JFbxImporter::ReadTextureCoord(FbxMesh* pFbxMesh, FbxLayerElementUV* pUVSet,
...
int JFbxImporter::GetSubMaterialIndex(int iPoly, FbxLayerElementMaterial* pMaterialSetList)
{
	int iSubMtrl = 0;
	if (pMaterialSetList)
	{
