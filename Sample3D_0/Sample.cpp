...
bool	Sample::Init()
{
	...
	JShader* pVShader = I_Shader.CreateVertexShader(m_pd3dDevice.Get(), L"Box.hlsl", "VS");
	JShader* pPShader = I_Shader.CreatePixelShader(m_pd3dDevice.Get(), L"Box.hlsl", "PS");
...
bool	Sample::Frame()
{
	...
	m_Camera.m_vCamera = m_PlayerObj.m_vPos + JVector3(0, 30.0f, -25.0f);
